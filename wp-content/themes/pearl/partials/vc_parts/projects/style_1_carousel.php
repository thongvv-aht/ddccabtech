        ...
        <div class="stm_projects_carousel__carousels owl-filter">
            <div class="stm_projects_carousel__carousel owl-carousel"
				...
				<?php while ($q->have_posts()): $q->the_post();
					...
					?>
                    <?php if($popup == 'true'): ?>
                        <a class="stm_video stm_video_style_2 stm_lightgallery__iframe has_cover stm_video_small stm_video_xsmall tbc has_poster" href="<?php echo sanitize_text_field($link);?>"
                            <?php post_class($project_classes); ?>
                           target="_self"
                           <?php the_title_attribute(); ?> data-iframe="true">
                            ...
                            <span class="btn btn_primary btn_solid btn_xs stm_projects_carousel__btn">
                                <?php esc_html_e('Play Video', 'pearl'); ?>
                            </span>
                        </a>
                    <?php else: ?>
                        <a class="link-text" href="<?php echo sanitize_text_field($link);?>"
                            <?php post_class($project_classes); ?>
                           target="_blank"
