...
if ($categories) { ?>
	<div class="<?php echo esc_attr(implode(' ', $classes)); ?>">
		...
		<?php if (!empty($title)) : ?>
			<h2 class="services_price_list__heading h2"><?php echo esc_html($title); ?></h2>
		<?php endif; ?>
			...
			<?php foreach ($categories as $key => $category) { ?>
				...
				<?php if ($posts->have_posts()) {
					...
					<div class="service__tab stm_lightgallery tab-pane <?php echo 0 === $key ? 'active' : '' ?>"
						...
						<?php
						if ($layout === 'list') : ?>
							<div class="services__tab_heading">
						...
						<?php while ($posts->have_posts()) {
							...
							<div <?php post_class(implode(' ', $post_classes)); ?>>
								...
								<div class="service__tab_item_body">
									<h4 <?php the_title_attribute(); ?> class="service__header service__name ttc">
										<?php if ($post_link) : ?>
											<a class="no_deco ttc" <?php the_title_attribute(); ?>
