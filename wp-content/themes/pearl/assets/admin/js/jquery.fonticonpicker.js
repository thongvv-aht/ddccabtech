...
;(function ($) {
   ...
   * @return {void}
   */
		initSourceIndex: function initSourceIndex() {
			// First check for any sorts of errors
			if (_typeof(this.settings.source) !== 'object') {
				return;
			}
   ...
   */
		renderIconContainer: function renderIconContainer() {
   ...
   */
		setHighlightedIcon: function setHighlightedIcon() {
   ...
   */
		setSelectedIcon: function setSelectedIcon(theIcon) {
   ...
   */
		toggleIconSelector: function toggleIconSelector() {
