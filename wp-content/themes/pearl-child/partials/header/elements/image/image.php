...
if(!empty($image)):
	...
	<div class="stm-logo">
		<a class="logo-nosticky" href="<?php echo esc_url($url); ?>" title="<?php echo esc_attr($image_alt); ?>">
			<?php echo wp_kses_post($image); ?>
		</a>
		<a class="logo-sticky" href="<?php echo esc_url($url); ?>" title="<?php echo esc_attr($image_alt); ?>">
			<?php echo wp_kses_post(str_replace('.png', '-sticky.png', $image)); ?>
		</a>
	</div>
