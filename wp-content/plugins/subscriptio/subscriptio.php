...
define('SUBSCRIPTIO_VERSION', '2.3.9');
...
class Subscriptio
{
    ...
    public function on_plugins_loaded()
    {
        ...
        add_action('init', array($this, 'maybe_migrate_stripe_gateway'));
    }
    ...
    public function maybe_migrate_stripe_gateway()
    {
        ...
        // Not our request
        if (empty($_GET['subscriptio_migrate_to_woocommerce_stripe'])) {
            return;
        }
