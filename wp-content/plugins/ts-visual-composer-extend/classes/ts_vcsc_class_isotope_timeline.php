					...
					if (!empty($featured_image)) {
						...
						if ($lightbox_featured == "false") {
							...
							$media_string .= '<div class="ts-timeline-media krautgrid-item krautgrid-tile kraut-lightbox-image" style="' . $parent_dimensions . '; ' . $image_alignment . '">';
								$media_string .= '<a href="' . $media_image[0] . '" class="kraut-lightbox-media no-ajaxy" data-title="' . $title_text . '" rel="' . ($lightbox_group == "true" ? "timelinegroup" : $lightbox_group_name) . '" data-effect="' . $lightbox_effect . '" data-duration="' . $lightbox_speed . '" ' . $nacho_color . '>';
									...
									if (!empty($title_text)) {
										$media_string .= '<div class="krautgrid-caption-text">' . $title_text . '</div>';
									}
								$media_string .= '</a>';
							$media_string .= '</div>';
						}
							...
							foreach ($featured_slider as $single_image) {
								...
								if ($lightbox_featured == "false") {
									if ((($i == 0) && ($vcinline_active == "true")) || ($vcinline_active == "false")) {
										$media_string .= '<div id="' . $timeline_id . '-' . $i .'-parent" class="' . $timeline_id . '-parent ' . $el_class . ' krautgrid-item krautgrid-tile kraut-lightbox-image" style="">';
									...
									if (($i == $nachoLength) && ($vcinline_active == "false")) {
										$media_string .= '<div id="' . $timeline_id . '-' . $i .'-parent" class="' . $timeline_id . '-parent ' . $el_class . ' krautgrid-item krautgrid-tile kraut-lightbox-image" style="">';
											$media_string .= '<a id="' . $timeline_id . '-' . $i .'" href="' . $modal_image[0] . '" data-title="" class="kraut-lightbox-media no-ajaxy ts-hover-image ' . $timeline_id . '-slider-image" rel="' . ($lightbox_group == "true" ? "timelinegroup" : $lightbox_group_name) . '" data-effect="' . $lightbox_effect . '" data-share="f" data-autoplay="' . ($lightbox_autoplay == "true" ? 1 : 0) . '" data-duration="' . $lightbox_speed . '" data-thumbsize="' . $thumbnail_height . '" data-thumbs="' . $thumbnail_position . '" ' . $nacho_color . '>';
												$media_string .= '<img src="' . $modal_image[0] . '" style="max-width: ' . $modal_image[1] . 'px; padding: 0; margin: 0 auto; display: block; ' . $image_dimensions . '">';
												$media_string .= '<div class="krautgrid-caption"></div>';
											$media_string .= '</a>';
										$media_string .= '</div>';
										...
										$media_string .= '<div id="' . $timeline_id . '-' . $i .'-parent" class="' . $timeline_id . '-parent ' . $el_class . ' krautgrid-item krautgrid-tile kraut-lightbox-image" style="">';
											$media_string .= '<a id="' . $timeline_id . '-' . $i .'" href="' . $modal_image[0] . '" data-title="" class="kraut-lightbox-media no-ajaxy ts-hover-image ' . $timeline_id . '-slider-image" rel="' . ($lightbox_group == "true" ? "timelinegroup" : $lightbox_group_name) . '" data-effect="' . $lightbox_effect . '" ' . $nacho_color . '>';
												$media_string .= '<img src="' . $modal_image[0] . '" style="max-width: ' . $modal_image[1] . 'px; padding: 0; margin: 0 auto; display: block; ' . $image_dimensions . '">';
												$media_string .= '<div class="krautgrid-caption"></div>';
											$media_string .= '</a>';
										$media_string .= '</div>';
				...
				if (($featured_media == 'youtube_default') || ($featured_media == 'youtube_custom') || ($featured_media == 'youtube_embed')) {
					...
					if (($featured_media == 'youtube_default')) {
						...
						$media_string .= '<div class="nch-holder krautgrid-item krautgrid-tile kraut-lightbox-youtube" style="' . $parent_dimensions . '; ' . $image_alignment . '">';
							$media_string .= '<a href="' . $featured_youtube_url . '" class="kraut-lightbox-media no-ajaxy" data-title="' . $title_text . '" data-related="' . $video_related . '" data-videoplay="' . $video_autoplay . '" data-type="youtube" rel="' . ($lightbox_group == "true" ? "timelinegroup" : $lightbox_group_name) . '" data-effect="' . $lightbox_effect . '" data-duration="' . $lightbox_speed . '" ' . $nacho_color . '>';
				...
				if (($featured_media == 'dailymotion_default') || ($featured_media == 'dailymotion_custom') || ($featured_media == 'dailymotion_embed')) {
					...
					if (($featured_media == 'dailymotion_default')) {
						...
						$media_string .= '<div class="nch-holder krautgrid-item krautgrid-tile kraut-lightbox-motion" style="' . $parent_dimensions . '; ' . $image_alignment . '">';
							$media_string .= '<a href="' . $featured_dailymotion_url . '" class="kraut-lightbox-media no-ajaxy" data-title="' . $title_text . '" data-videoplay="' . $video_autoplay . '" data-type="dailymotion" rel="' . ($lightbox_group == "true" ? "timelinegroup" : $lightbox_group_name) . '" data-effect="' . $lightbox_effect . '" data-duration="' . $lightbox_speed . '" ' . $nacho_color . '>';
								$media_string .= '<img src="' . $media_image . '" title="" style="display: block; ' . $image_dimensions . '">';
								$media_string .= '<div class="krautgrid-caption"></div>';
								if (!empty($title_text)) {
									$media_string .= '<div class="krautgrid-caption-text">' . $title_text . '</div>';
				...
				if (($featured_media == 'vimeo_default') || ($featured_media == 'vimeo_custom') || ($featured_media == 'vimeo_embed')) {
					...
					if (($featured_media == 'vimeo_default')) {
						...
						$media_string .= '<div class="nch-holder krautgrid-item krautgrid-tile kraut-lightbox-vimeo" style="' . $parent_dimensions . '; ' . $image_alignment . '">';
							$media_string .= '<a href="' . $featured_vimeo_url . '" class="kraut-lightbox-media no-ajaxy" data-title="' . $title_text . '" data-videoplay="' . $video_autoplay . '" data-type="vimeo" rel="' . ($lightbox_group == "true" ? "timelinegroup" : $lightbox_group_name) . '" data-effect="' . $lightbox_effect . '" data-duration="' . $lightbox_speed . '" ' . $nacho_color . '>';
								$media_string .= '<img src="' . $media_image . '" title="" style="display: block; ' . $image_dimensions . '">';
								$media_string .= '<div class="krautgrid-caption"></div>';
								if (!empty($title_text)) {
									$media_string .= '<div class="krautgrid-caption-text">' . $title_text . '</div>';
						...
						$output .= '<div class="ts-timeline-text-wrap ' . (!empty($date_text) ? "ts-timeline-text-wrap-date" : "ts-timeline-text-wrap-nodate") . '" style="' . $margin_Adjust . '">';
							...
							if ($full_width == "true") {
								...
								$output .= '<div class="ts-timeline-full-colB" style="' . $columnB_adjust . '">';
									if (!empty($title_text)) {
										$output .= '<' . $title_wrap . ' class="ts-timeline-title" style="color: ' . $title_color . '; text-align: ' . $title_align . '; ' . (empty($content) && (empty($icon)) ? "border: none; margin-bottom: 0; padding-bottom: 0;" : "") . ' ' . $title_margin . '">' . $title_text . '</' . $title_wrap . '>';
									}
					...
					$output .= '<div class="ts-timeline-column" style="margin: 0;">';
						$output .= '<div class="ts-timeline-text-wrap" style="background-color: ' . $color_background . ';">';
							$output .= '<div class="ts-timeline-text-wrap-inner" style="width: 100%; left: 0; ' . $title_margin . '">';
								if (!empty($title_text)) {
									$output .= '<' . $title_wrap . ' class="ts-timeline-title" style="text-align: ' . $title_align . '; color: ' . $title_color . ';' . $title_margin . '">' . $title_text . '</' . $title_wrap . '>';
								}
								if (!empty($content_text)) {
							...
							if ((!empty($timeline_title)) || (!empty($timeline_description))) {
								$output .= '<div class="ts-timeline-header">';
									if (!empty($timeline_title)) {
										$output .= '<' . $timeline_title_wrap . ' class="ts-timeline-header-title" style="color: ' . $timeline_title_color . ';">' . $timeline_title . '</' . $timeline_title_wrap . '>';
									}
						...
						$output .= '<div class="ts-timeline-footer-wrap">';
							...
							if ((!empty($timeline_title)) || (!empty($timeline_description))) {
								$output .= '<div class="ts-timeline-footer">';
									if (!empty($timeline_title)) {
										$output .= '<' . $timeline_title_wrap . ' class="ts-timeline-footer-title" style="color: ' . $timeline_title_color . ';">' . $timeline_title . '</' . $timeline_title_wrap . '>';
									}
									if (!empty($timeline_description)) {
