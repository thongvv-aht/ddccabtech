							...
							if ((!empty($timeline_title)) || (!empty($timeline_description))) {
								$output .= '<div class="ts-timeline-header">';
									if (!empty($timeline_title)) {
										$output .= '<' . $title_wrap . ' class="ts-timeline-header-title" style="color: ' . $timeline_title_color . ';">' . $timeline_title . '</' . $title_wrap . '>';
									}
						...
						$output .= '<div class="ts-timeline-footer-wrap">';
							...
							if ((!empty($timeline_title)) || (!empty($timeline_description))) {
								$output .= '<div class="ts-timeline-footer">';
									if (!empty($timeline_title)) {
										$output .= '<' . $title_wrap . ' class="ts-timeline-footer-title" style="color: ' . $timeline_title_color . ';">' . $timeline_title . '</' . $title_wrap . '>';
									}
									if (!empty($timeline_description)) {
