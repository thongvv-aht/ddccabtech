<?php
	...
	function TS_VCSC_Font_Iconbox_Tiny_Function ($atts, $content = null) {
		...
		if (!empty($icon_image)) {			
			$icon_image_alt 			= get_post_meta($icon_image, '_wp_attachment_image_alt', true);
		...
		if ($style == "boxed") {
			if ($icon_location == "top") {
				...
				if ($box_border_type == '') {
					$box_frame_adjust	= 'margin-right: 0px; padding: 0 ' . $box_padding_side . ' 0 0;';
				} else {
							...
							$output .= '<div class="ts-icon-box-inner box-detail-wrapper ' . $box_border_radius . ' ' . $height_class . '" style="' . $box_frame_style . ' ' . $box_inner_padding . ' ' . $height_setting . '">';
								$output .= '<div class="ts-box-icon-title-holder" style="display: table; margin: 0 auto ' . $title_spacing . 'px auto; float: ' . ($title_align == 'center' ? 'none' : $title_align) . ';">';
									if ($icon_replace == 'false') {
										if (!empty($icon)) {
											$output .= '<i class="ts-box-icon-title-icon ' . $icon . ' ts-main-ico ts-font-icon ' . $icon_frame_radius . ' ' . $icon_frame_class . ' ' . $animation_icon .'" style="margin-left: 0px; margin-right: ' . $icon_margin . 'px; color:' . $icon_color . ';' . $icon_style . ' ' . $icon_frame_style . '"></i>';
										}
									} else {
										if (!empty($icon_image)) {
											$output .= '<div style="width: auto !important; display: table-cell;">';
												$output .= '<img class="ts-box-icon-title-image ts-main-ico ts-font-icon ' . $icon_frame_class . ' ' . $animation_icon . ' ' . $icon_frame_radius . '" src="' . $icon_image_path[0] . '" alt="'. $icon_image_alt . '" style="margin-left: 0px; margin-right: ' . $icon_margin . 'px; ' . $icon_frame_style . ' ' . $icon_image_style . ' display: inline-block !important;">';
											$output .= '</div>';
										}
									}
						...
						$output .= '<div class="ts-css-shadow ' . $animation_shadow . ' ' . $box_border_radius . '" style="' . $box_background_style . '">';
							$output .= '<div class="ts-icon-box-inner box-detail-wrapper ' . $box_border_radius . ' ' . $height_class . '" style="' . $box_frame_style . ' ' . $box_inner_padding . ' ' . $height_setting . '">';
								$output .= '<div class="ts-box-icon-title-holder" style="display: table; margin: 0 auto ' . $title_spacing . 'px auto; float: ' . ($title_align == 'center' ? 'none' : $title_align) . ';">';
									...
									if ($icon_replace == 'false') {
										if (!empty($icon)) {
											$output .= '<i class="ts-box-icon-title-icon ' . $icon . ' ts-main-ico ts-font-icon ' . $icon_frame_radius . ' ' . $icon_frame_class . ' ' . $animation_icon .'" style="margin-left: ' . $icon_margin . 'px; margin-right: 0px; color:' . $icon_color . ';' . $icon_style . ' ' . $icon_frame_style . '"></i>';
										}
									} else {
										if (!empty($icon_image)) {
											$output .= '<div style="width: auto !important; display: table-cell;">';
												$output .= '<img class="ts-box-icon-title-image ts-main-ico ts-font-icon ' . $icon_frame_class . ' ' . $animation_icon . ' ' . $icon_frame_radius . '" src="' . $icon_image_path[0] . '" alt="'. $icon_image_alt . '" style="margin-left: ' . $icon_margin . 'px; margin-right: 0px; ' . $icon_frame_style . ' ' . $icon_image_style . ' display: inline-block !important;">';
											$output .= '</div>';
										}
									}						
								$output .= '</div>';
						...
						$output .= '<div class="ts-css-shadow ' . $animation_shadow . ' ' . $box_border_radius . '" style="' . $box_background_style . '">';
							$output .= '<div class="ts-icon-box-inner top-side ' . $animation_css . ' ' . $box_border_radius . ' ' . $height_class . '" style="' . $box_frame_style . ' ' . $box_inner_padding . ' ' . $height_setting . '">';
								...
								if ($icon_replace == 'false') {
									...
									if (!empty($icon_image)) {
										$output .= '<img class="ts-box-icon-title-image ts-main-ico ts-font-icon ' . $icon_frame_class . ' ' . $animation_icon . ' ' . $icon_frame_radius . '" src="' . $icon_image_path[0] . '" alt="'. $icon_image_alt . '" style="' . $icon_float . ' ' . $icon_frame_style . ' ' . $icon_image_style . ' display: inline-block !important;">';
									}
								}
							...
							$output .= '<div class="ts-icon-box-boxed  ' . $icon_location . $animation_css . ' ' . $box_border_radius . '" style="' . $box_frame_style . ' ' . $box_inner_padding . ' ' . $box_padding_top . ' ' . $box_frame_adjust . ' ' . $box_background_style . '">';
								if ($separator_type != '') {
									...
									if ($icon_replace == 'false') {
										...
										if (!empty($icon_image)) {
											$output .= '<img class="ts-box-icon-title-image ts-main-ico ts-font-icon ' . $icon_frame_class . ' ' . $animation_icon . ' ' . $icon_frame_radius . '" src="' . $icon_image_path[0] . '" alt="'. $icon_image_alt . '" style="' . $icon_frame_style . ' ' . $icon_image_style . ' ' . $icon_frame_adjust . ' display: inline-block !important; margin-right: ' . $icon_margin . 'px;">';
										}
									}									
