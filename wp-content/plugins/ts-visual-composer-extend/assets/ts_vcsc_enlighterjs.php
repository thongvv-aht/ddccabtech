	...
	<div id="ts-settings-about" class="tab-content">
		<div class="ts-vcsc-settings-group-header">
			<div class="display_header">
				<h2><span class="dashicons dashicons-editor-code"></span>Composium - WP Bakery Page Builder Extensions v<?php echo TS_VCSC_GetPluginVersion(); ?> ... EnlighterJS (Syntax Highlighter)</h2>
			</div>
			<div class="clear"></div>
		</div>
			...
			<div class="ts-vcsc-section-main">
				...
				<div class="ts-vcsc-section-content">
					...
					<div class="ts-advanced-link-button-wrapper ts-advanced-link-tooltip-holder" style="margin: 0;">
						<span class="ts-advanced-link-tooltip-content"><?php _e("Click here to update the syntax highlighter theme preview below, based on your custom settings.", "ts_visual_composer_extend"); ?></span>
