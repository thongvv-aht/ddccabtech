...
class OrderFulfillmentDataStore
{
    ...
    /**
     * OrderFulfillmentDataStore constructor.
     *
     * @since x.y.z
     */
    ...
    /**
     * Get data from the shipment tracking plugin.
     *
     * @since x.y.z
     *
     * @param int $orderId
    ...
    /**
     * Get the stored MD5 hash of the data from the shipment tracking plugin.
     *
     * @since x.y.z
     *
     * @param int $orderId
    ...
    /**
     * Convert data from Shipment Tracking plugin into ShipmentContract objects.
     *
     * @since x.y.z
     *
     * @param array $data
