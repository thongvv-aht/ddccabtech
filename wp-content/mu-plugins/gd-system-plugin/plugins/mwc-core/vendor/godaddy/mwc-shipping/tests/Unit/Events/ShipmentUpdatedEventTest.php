...
/**
 * @covers \GoDaddy\WordPress\MWC\Shipping\Events\ShipmentUpdatedEvent
 */
class ShipmentUpdatedEventTest extends WPTestCase
{
    /**
    ...
    public function testExtends()
    {
        ...
        $this->assertInstanceOf(AbstractShipmentEvent::class, new ShipmentUpdatedEvent($orderFulfillment, $shipment));
    }
}
