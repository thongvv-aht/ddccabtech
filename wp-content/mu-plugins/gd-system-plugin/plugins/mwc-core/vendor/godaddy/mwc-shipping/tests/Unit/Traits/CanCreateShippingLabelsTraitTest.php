...
use GoDaddy\WordPress\MWC\Shipping\Traits\CanCreateShippingLabelsTrait;
use WP_Mock;

/**
 * @covers \GoDaddy\WordPress\MWC\Shipping\Traits\CanCreateShippingLabelsTrait
 */
class CanCreateShippingLabelsTraitTest extends WPTestCase
{
    /**
     * Tests that can send a request to create shipping labels.
     *
     * @covers \GoDaddy\WordPress\MWC\Shipping\Traits\CanCreateShippingLabelsTrait::create()
     *
    ...
    public function testCanEstimateShippingRates()
    {
        ...
        $this->assertIsArray($instance->create($shipments));
    }
